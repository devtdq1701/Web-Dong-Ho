...
namespace WebDongHo.Areas.Admin.Controllers
{
    public class SlidesController : BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description,Link,Images,Order,Status")] Slide slide)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description,Link,Images,Order,Status")] Slide slide)
        {
            if (ModelState.IsValid)
            {
